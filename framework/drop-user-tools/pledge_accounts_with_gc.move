...
use ol_framework::gas_coin::GasCoin;
        ...
        public(friend) fun withdraw_from_all_pledge_accounts(sig_beneficiary: &signer, amount: u64): option::Option<coin::Coin<GasCoin>> acquires MyPledges, BeneficiaryPolicy {
            ...
            while (i < vector::length(&pledgers)) {
                ...
                if (!account::exists_at(pledge_account) || account::is_tombstone(pledge_account)) {
