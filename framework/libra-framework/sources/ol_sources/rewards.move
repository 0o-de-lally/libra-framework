...
use ol_framework::gas_coin::GasCoin;
  ...
  /// belt and suspenders
  fun pay_reward(root: &signer, addr: address, coin: Coin<GasCoin>, reward_type: u8) {
  ...
  public fun test_helper_pay_reward(root: &signer, addr: address, coin: Coin<GasCoin>, reward_type: u8) {
